...
pegasus_client_impl::pegasus_client_impl(const char *cluster_name, const char *app_name)
    : _cluster_name(cluster_name), _app_name(app_name), _dns_resolver(new dsn::dns_resolver())
{
    ...
    _client = new ::dsn::apps::rrdb_client(cluster_name, meta_servers, app_name, _dns_resolver);
}
    ...
    async_get_unordered_scanners_callback_t &&callback)
{
    ...
    ::dsn::rpc::call(_dns_resolver->resolve_address(_meta_server),
