...
struct bulk_load_request
{
    ...
    10:dsn.host_port    hp_primary_addr;
}
...
struct bulk_load_response
{
    ...
    11:map<dsn.host_port, partition_bulk_load_state>    hp_group_bulk_load_state;
}
...
struct group_bulk_load_request
{
    ...
    8:dsn.host_port                 hp_target_address;
}
...
struct query_bulk_load_response
{
    ...
    9:list<map<dsn.host_port, partition_bulk_load_state>>   hp_bulk_load_states;
}
